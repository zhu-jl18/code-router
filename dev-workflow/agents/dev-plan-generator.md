...
- fish-agent-wrapper analysis results (feature highlights, task decomposition, UI detection flag, and task typing hints)
...
1. **Analyze Input**: Review the requirements description and fish-agent-wrapper analysis results (including `needs_ui` and any task typing hints)
